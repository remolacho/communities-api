...
class UserRoles::Import::RemoveService
  ...
  def remove_roles
    ...
    data_hash.each do |data|
      ...
      next errors << I18n.t('services.user_roles.import.remove.error.user_not_found', identifier: data['identifier']) unless user_h.present?
