...
RSpec.describe Petitions::List::ListGroupRolesService do
  ...
  context 'When 1 user want see list of petitions' do
    ...
    it 'return empty, the user has role admin, but there is not petitions' do
      user_role_owner_admin
      user_role_admin
      group_role_admin
    ...
    it 'return empty there is not petitions for group role admin, the user has role admin' do
      user_role_owner_admin
      user_role_admin
      group_role_admin
