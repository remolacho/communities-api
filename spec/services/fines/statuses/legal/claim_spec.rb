...
RSpec.describe Fines::Statuses::Legal::Claim do
  include_context 'legal_status_fines_stuff'

  context 'when getting list of allowed statuses for claim legal fine' do
    before do
    ...
    it 'creator can only see claim status' do
      user_role_creator
    ...
    it 'owner can only see claim status' do
      user_role_owner
