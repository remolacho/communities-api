...
RSpec.describe Fines::Statuses::Legal::Closed do
  include_context 'legal_status_fines_stuff'

  context 'when getting list of allowed statuses for closed legal fine' do
    before do
    ...
    it 'creator can only see closed status' do
      user_role_creator
    ...
    it 'owner can only see closed status' do
      user_role_owner
